...
const Services = () => {
  const services = [
    {
      ...
      description:
        " Build responsive and interactive web applications using the latest technologies.",
    },
    {
      icon: <PiShapes />,
      title: "UI/UX Design",
      description:
        " Delivering optimized, user-friendly experiences that enhance engagement and maximize the efficiency of digital products.",
    },
    {
      icon: <PiPenNib />,
      title: "Graphic Design",
      description:
        " Create visually appealing designs that effectively communicate your brand message.",
    },
    {
      icon: <BsLayers />,
      title: "Backend Development",
      description:
        " Design scalable and efficient server-side applications with modern backend technologies .",
    },
  ];
  ...
  return (
    <div
      id="services"
      className="div-container bg-primary-gray min-h-screen py-20"
    >
      <Wrapper>
        <div className="flex flex-col h-full justify-center items-center w-full px-3 xl:px-0">
          <Heading tag="h1" text="Services" styleType="h1" />
          <Heading
            tag="h2"
