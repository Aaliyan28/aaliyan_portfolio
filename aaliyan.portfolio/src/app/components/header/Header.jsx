      ...
      >
        <div className="flex justify-between md:max-w-screen-lg xl:max-w-screen-xl items-center w-full mx-auto px-3">
          ...
          <div className="hidden lg:block">
            <nav
              className={`space-x-6 flex justify-between gap-x-5 ${
                isOpen ? "text-black" : "text-white"
              }`}
            >
              {["Home", "Portfolio", "About", "Testimonial", "Contact"].map(
                (text, index) => (
                  <motion.div
                    key={text}
                    initial="hidden"
          ...
          >
            ...
            >
              <div
                className={`w-10 h-[1px] rounded-full mt-[1px] transition-all duration-300 ${
                  isOpen
                    ? "bg-primary-white rotate-45 translate-y-[0.4rem]"
                    : "bg-white"
                }`}
              />
              <div
                className={`w-10 h-[1px] rounded-full transition-all duration-300 ${
                  isOpen
                    ? "bg-primary-white translate-x-full opacity-0"
                    : "bg-white"
                }`}
              />
              <div
                className={`w-10 h-[1px] rounded-full mt-[1px] transition-all duration-300 ${
                  isOpen
                    ? "bg-primary-white -rotate-45 -translate-y-[0.75rem]"
                    : "bg-white"
                }`}
              />
            </button>
